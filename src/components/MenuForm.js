...
const MenuForm = ({
  ...
  // search letters will be all letters, if the user has searched for all
  ...
  // set the selected letters as the letters previously searched for, if any
...
MenuForm.propTypes = {
  ...
  searchedForAllLetters: PropTypes.bool,
};
